...
<html lang="en">
  <head>
    ...
    <title>Bootstrap powered database</title>
...
xmlhttp.open("GET","../includes/tmp/xml_listings.xml",false);
xmlhttp.send();
xmlDoc=xmlhttp.responseXML; 
x=xmlDoc.getElementsByTagName("LISTING");

function displayListinginfo(i)
{
title=(x[i].getElementsByTagName("TITLE")[0].childNodes[0].nodeValue);
aid=(x[i].getElementsByTagName("AID")[0].childNodes[0].nodeValue);
...
reserves=(x[i].getElementsByTagName("RESERVES")[0].childNodes[0].nodeValue);
...
txt="Title: "+title+"<br>Adv. ID: "+aid+"<br>Itemid: "+itemid+"<br>Description: "+desc+"<br>Cost in Reserves: "+reserves+"<br>Count: "+amount+"<br>Image: "+image;
document.getElementById("showListinginfo").innerHTML=txt;
}
</script>
	...
	<div class="panel-default">
			...
			<div class="col-lg-6">
	        			<div class="form-group panel-body">
		        			<img src="img/service-icon/diamond.png" alt="Add a listing to classifieds">
<form class="panel form-group"  method="post" action="../includes/listing.php">
Itemid: <input class="form-control" type="text" name="itemid" required>
<span class="error"> <?php  echo $nameErr;?></span>
<br><br>
Amount: <input class="form-control" type="text" name="amount" required>
<span class="error"><?php  echo $nameErr;?></span>
<br><br>
Title: <input class="form-control" type="text" name="title" required>
<span class="error"><?php  echo $nameErr;?></span>
<br><br>
Offer in Reserves: <input class="form-control" type="text" name="reserves" required>
<span class="error"><?php  echo $nameErr;?></span>
<br><br>
<label for="postid">Short Description: </label><br>
<textarea style="width:100%;" name="desc" id="postid" rows="4" col="3" placeholder="400 Character Limit" class="inputbox autowidth add-border" title="body" type="text" required></textarea>
<br><br>
Pin: <input class="form-control" type="text" name="pin" required>
<span class="error"><?php  echo $nameErr;?></span>
<br><br>
<input class="btn btn-success" type="submit" name="submit" value="Submit"></form><br>
	        			</div>
		...
		<div class="col-lg-6">
		<h3>Listings:</h3>
		<div id='showListinginfo'>Click on a Listing to display complete information.</div><br>
		<table class="table table-responsive table-hover" id="boxscroll4">
		<tr>
		<th>Listing ID</th>
		<th>Title</th>
		<th>Count</th>
		<th>Cost in Reserves</th>
		</tr>
<script>
for (var i=0;i<x.length;i++)
  { 
  document.write("<tr onclick='displayListinginfo(" + i + ")'>");
  document.write("<td>");
  document.write(x[i].getElementsByTagName("AID")[0].childNodes[0].nodeValue);
  document.write("</td><td>");
  document.write(x[i].getElementsByTagName("TITLE")[0].childNodes[0].nodeValue);
  document.write("</td><td>");
  document.write(x[i].getElementsByTagName("AMOUNT")[0].childNodes[0].nodeValue);
  document.write("</td><td>");
  document.write(x[i].getElementsByTagName("RESERVES")[0].childNodes[0].nodeValue);
